    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.ceph.CephTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class CephTask extends Task implements RunnableTask<CephTask.Output> {
    @Schema(
    ...
    @Override
    public CephTask.Output run(RunContext runContext) throws Exception {
